const images = require.context('./images', true, /\.png$/); // require.context makes webpack aware of the image urls so that we can ref them in the json data below w/ relative urls
